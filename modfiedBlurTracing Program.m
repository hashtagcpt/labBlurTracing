...
% on the Mac
% mainDir = '~/Exp/bexlab/blurTracing/localSlopeImageStats';
% dataDir = '~/Exp/bexlab/blurTracing/localSlopeImageStats/data';

mainDir = '~/Clouds/Dropbox/blurTracing/localSlopeImageStats';
dataDir = '~/Clouds/Dropbox/blurTracing/localSlopeImageStats/data';

cd(mainDir);

calibrated = 1; % 1 for McGill Images, 2 for Web Images
if calibrated
    imType = 'McGill';
else
    imType = 'Web';
